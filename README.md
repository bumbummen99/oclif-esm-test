...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 linux-x64 node-v19.5.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/bumbummen99/oclif-esm-test/blob/v0.0.0/dist/commands/hello/index.ts)_
